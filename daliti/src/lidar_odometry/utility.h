...
public:
    ...
    Eigen::Quaterniond Q_quat_lidar; 
#endif
    ...
    ParamServer()
    {
        ...
        nh.param<std::string>(PROJECT_NAME + "/lidarFrame", lidarFrame, "lidar_link");
        nh.param<std::string>(PROJECT_NAME + "/baselinkFrame", baselinkFrame, "lidar_link");
        nh.param<std::string>(PROJECT_NAME + "/odometryFrame", odometryFrame, "camera_init");
